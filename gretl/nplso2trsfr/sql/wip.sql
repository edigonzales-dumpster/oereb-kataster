...
(
  ...
  --WHERE
    ...
    WHERE
      grundnutzung.rechtsstatus IS NOT NULL -- Fehler (jedoch erlaubt in unserem Modell
)
,
...
SELECT
  *
FROM 
 transferstruktur_hinweisvorschrift_grundnutzung;
/*
,
...
(
  ...
  WHERE
    ueberlagernd_flaeche.rechtsstatus IS NOT NULL -- Fehler (jedoch erlaubt in unserem Modell
  AND
...
(
  ...
  WHERE
    ueberlagernd_linie.rechtsstatus IS NOT NULL -- Fehler (jedoch erlaubt in unserem Modell
  AND
...
(
  ...
  WHERE
    ueberlagernd_punkt.rechtsstatus IS NOT NULL -- Fehler (jedoch erlaubt in unserem Modell
  AND
...
SELECT
  *
FROM
  transferstruktur_geometrie_ueberlagernd_punkt_insert
; 
