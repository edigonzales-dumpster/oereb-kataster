...
vorschrift_dokument_update_zustaendige_stelle_gemeinden AS (
  ...
  AND
    (abkuerzung_de !='RRB' OR abkuerzung_de IS NULL)
  AND 
...
transferstruktur_eigentumsbeschraenkung_update_zustaendige_stelle AS (
  ...
  RETURNING transferstruktur_eigentumsbeschraenkung.t_id, transferstruktur_eigentumsbeschraenkung.zustaendigestelle
)
,
transferstruktur_geometrie_update_zustaendige_stelle AS (
  ...
  (
    ...
    FROM
      ...
      LEFT JOIN transferstruktur_eigentumsbeschraenkung_update_zustaendige_stelle AS eigentumsbeschraenkung
